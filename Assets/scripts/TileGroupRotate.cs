...
public class TileGroupRotate : TileGroupTransition
{
    ...
    public override void LerpObjects(float duration, float time)
    {
        ...
        for (int i = 0; i < TileLength; i++)
        {
            ...
            if (angle == 0)
            {
                ...
                RotateTile(i, durationsplit, time, StartAngle, Quaternion.identity);
            }
    ...
    void RotateTile(int TileIndex, float DurationSplit, float time, Quaternion StartAngle, Quaternion EndAngle)
    {
        ...
        Quaternion rotation = Quaternion.Lerp(StartAngle, EndAngle, localTime / DurationSplit);
